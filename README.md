...
HappyMatch 是一个基于 HarmonyOS 6.0.2 SDK 开发的三消闯关游戏项目。项目目标是完成一个适合作为期末大作业展示的完整游戏闭环：从首页、选关、关卡游玩、道具、结算、成就到本地进度保存，形成可运行、可演示、可继续扩展的鸿蒙应用。
...
目前道具数量设置为无限，方便课堂展示和调试。后续可以接入模拟商店或支付流程。
...
本项目目前以本地演示和课程作业为主要目标，没有接入真实支付、登录或云数据库。所有核心玩法、关卡配置和进度逻辑都保留在本地，方便开发、调试和课堂展示。
